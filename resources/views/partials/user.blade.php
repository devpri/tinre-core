<div class="content-inner flex justify-end">
      ...
      <v-popover placement="bottom-start">
        ...
        <template class="hidden" slot="popover">
          <ul class="text-gray-700 pt-1 mx-4">
              <li class="">
                  <router-link v-close-popover :to="{ name: 'users.index' }" class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap w-40">
                      {{ __('Users') }}
                  </router-link>
              </li>
          </ul>
    ...
    <v-popover placement="bottom-start">
      ...
      <template class="hidden" slot="popover">
        <ul class="text-gray-700 pt-1 mx-4">
            <li class="">
                <router-link v-close-popover :to="{ name: 'profile' }" class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap w-40">
                    {{ __('Profile') }}
                </router-link>
            </li>
            <li class=""><a class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap w-40" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ __('Logout') }}</a></li>
        </ul>
